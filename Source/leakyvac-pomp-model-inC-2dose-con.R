...
seir.leaky.vac.step.C <- '
  ...
  double sec_vac = 0.0;
  double vac_starts_1=60.0; //day 60
  double vac_starts_2=79.0;
  double vac_ends_1=65.0;
  double vac_ends_2=84.0; // no second vac
  double daily_vac=82815.0; // assuing 50% coverage note that this is daily vac rate here
...
seir.leaky.vac.skel.C <- '
  ...
  double vac_rate_2=0.0;
  double sec_vac = 0.0;
  double vac_starts_1=60.0; //day 45
  double vac_starts_2=79.0;
  double vac_ends_1=65.0;
  double vac_ends_2=84.0; // no second vac
  double daily_vac=82815.0; // assuing 65% coverage note that this is weekly vac rate here
...
build.leaky.model.C <- function(pop=13.4e6,
    ...
    my.mod <- pompBuilder(
        ...
        step.fn.delta.t=1/10, # 1/10th of a day for zim
