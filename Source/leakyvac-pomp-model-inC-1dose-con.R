...
seir.leaky.vac.step.C <- '
  ...
  double sec_vac = 0.0;
  double vac_starts_1=60.0;
  double vac_starts_2=5000.0;
  double vac_ends_1=70.0;
  double vac_ends_2=5000.0; // no second vac
  double daily_vac=82815.0; // 50% coverage here
...
seir.leaky.vac.skel.C <- '
  ...
  double vac_ends_1=70.0;
  double vac_ends_2=5000.0; // no second vac
  double daily_vac=82815.0; // assuing 1e6 doses  note that this is daily vac rate here
...
build.leaky.model.C <- function(pop=13.4e6,
    ...
    my.mod <- pompBuilder(
        ...
        step.fn.delta.t=1/10, # 1/10th of a day for conakry
